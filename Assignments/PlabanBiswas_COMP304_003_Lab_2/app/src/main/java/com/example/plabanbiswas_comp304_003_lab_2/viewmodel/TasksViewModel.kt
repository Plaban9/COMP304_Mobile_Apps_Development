...
fun TaskCardData(context: Context, id: Int, title: String, content: String, timestamp: Timestamp, isTaskDone: Boolean)
{
    ...
    ElevatedCard(
            ...
            onClick = {
                NavigateToEdit(context = context, id = id, title = title, content = content, isCompleted = isTaskCompleted)
            }
    ) {
        Row(
                modifier = Modifier
...
fun NavigateToEdit(context: Context, id: Int, title: String, content: String, isCompleted: Boolean)
{
